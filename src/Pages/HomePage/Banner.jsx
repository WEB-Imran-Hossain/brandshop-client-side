            ...
            <div className="hero min-h-screen"
                ...
                <div className="w-full lg:px-40">
                    <div className="text-white mt-20 ">
                        ...
                        <p className="text-lg font-medium text-center p-5 md:p-0">We believe that beauty knows no boundaries and that every shade,texture, and finish should be celebrated. </p>
